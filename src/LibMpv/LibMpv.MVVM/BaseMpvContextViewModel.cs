...
public abstract partial class BaseMpvContextViewModel: MpvContext
{
    ...
    //{
    //    get => this.GetPropertyFlag("sub-visibility") ?? false;
    //    set => this.GetPropertyFlag("sub-visibility", value);
    //}

    //public string TrackList
    //{
    //    get => this.GetPropertyString("track-list") ?? "null";
    //}

    public bool SubVisibility(bool visible)
    {
        string[] args = { "sub-visibility", visible ? "yes" : "no", null };
        Command("sub-visibility", "yes");
        return true;
    }
    ...
    //public string TrackList
    //{
    //    get => this.GetPropertyString("track-list");
    //    set
    //    {
    //        if (value != null)
    //        {
    ...
    protected virtual void InitPropertyObserver()
    {
        ...
        //this.ObserveProperty("track-list", () => RaisePropertyChangedInUIThread(nameof(TrackList)));
    }
